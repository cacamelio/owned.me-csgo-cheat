...
bool interfaces::initialize() 
{
	...
	surface_props = get_interface<IPhysicsSurfaceProps>(XOR("vphysics.dll"), XOR("VPhysicsSurfaceProps"));
	...
	g::SetAbsOrigin = pattern::Scan(XOR("client.dll"), XOR("55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8 ? ? ? ? 8B 7D"));
	g::LockStudioHdr = pattern::Scan(XOR("client.dll"), XOR("55 8B EC 51 53 8B D9 56 57 8D ? ? ? ? ? FF"));
	...
	convars::min_update_rate = interfaces::console->FindVar(XOR("sv_minupdaterate"));
