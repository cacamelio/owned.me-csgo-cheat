...
public:
	INetChannel_info* get_net_channel_info() {
		using original_fn = INetChannel_info * (__thiscall*)(IVEngineClient*);
	...
	bool is_playing_demo() {
		return utilities::CallVirtual<bool(__thiscall*)(void*)>(this, 82)(this);
	}

	bool is_hltv() {
		return utilities::CallVirtual<bool(__thiscall*)(void*)>(this, 93)(this);
	}
	...
	int get_tick()
	{
		...
		return utilities::CallVirtual<Fn>(this, 208)(this);
	}

	bool voice_record() {
		typedef bool(__thiscall* Fn)(void*);
		return utilities::CallVirtual<Fn>(this, 224)(this);
	}
};
