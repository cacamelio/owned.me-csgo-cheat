...
namespace render {
	...
	void circle3d(vec3_t pos, int point_count, float radius, Color color);
	void filled_circle3d(vec3_t pos, float radius, Color color);
	void triangle(vec2_t p1, vec2_t p2, vec2_t p3, Color color);
